...
import Expertise from "../../../../public/images/expertise.webp";
import Legacy from "../../../../public/images/legacy.webp";
import Network from "../../../../public/images/expand.webp";
        ...
        <section className={styles.section}>
            ...
            <div className={styles.flex}>
                <div className={styles.card}>
                    ...
                    <Image src={Impact} alt="Impact" width={300} height={400} className={styles.cardImage} />
                </div>
                <div className={styles.card}>
                    ...
                    <Image src={Expertise} alt="Expertise" width={300} height={400} className={styles.cardImage} />
                </div>
                <div className={styles.card}>
                    ...
                    <Image src={Legacy} alt="Legacy" width={300} height={400} className={styles.cardImage} />
                </div>
                <div className={styles.card}>
                    ...
                    <Image src={Network} alt="Network" width={300} height={400} className={styles.cardImage} />
                </div>
            </div>
        </section>
    )
