...
import styles from './mentorWaitlist.module.css';
...
export default function MentorWaitlist() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      Swal.fire({
        ...
        text: `You've joined as a mentor.`,
        confirmButtonColor: '#452c15',
        timer: 2500,
  ...
  return (
    <section className={styles.hero} id="mentor-waitlist">
      <div className={styles.heroLeft}>
        <div className={styles.overlay} />

        <div className={styles.heroContent}>
          <h2>Help build the next <br /> generation of  <br /> African research <br />leaders.</h2>
        </div>
      </div>
